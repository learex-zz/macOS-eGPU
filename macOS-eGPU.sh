...
macOSeGPUdaemonPlistPath="/Library/LaunchDaemons/scp.learex.macOS-eGPU-daemon.plist"
macOSeGPUDaemonPath="/usr/local/bin/macOS-eGPU-daemon"
...
<dict>
    <key>Label</key>
    <string>macOS-eGPU-daemon</string>
    <key>KeepAlive</key>
    <false/>
    <key>RunAtLoad</key>
    <true/>
